...
// is url paramater "id" set (ie. http://local/detail.php?id
if (isset($_GET["id"])) {
	$id = $_GET["id"]; //get and save id paramater
//if the id exist in catalog array	
	if (isset($catalog[$id])) {
		$item = $catalog[$id];  //save catalog item as $item
	}
}


//if there is not set $item
if (!isset($item)) {
...
<div class="section page">
	<div class="wrapper">
		...
		<div class="breadcrumbs">
			<a href="catalog.php">Full Catalogue</a>
		...
		<div class="media-details">
			...
			<table>
				...
				<?php  if (strtolower($item["category"]) == "books")  { ?>
						<tr>
							<th>Authors</th>
<!--							implode is similar to join() in js, outputting array into strings-->
